...
public class drinkFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TabLayout tabs = (TabLayout) view.findViewById(R.id.drink_tabs);
   ...
   /* @Override
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        drinkFragment.Adapter adapter = new drinkFragment.Adapter(getChildFragmentManager());
        adapter.addFragment(new NewDrinkFragment(), "New Drink");
